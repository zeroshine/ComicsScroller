...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				Paper,
				{ className: 'material-card', key: this.props.index, zDepth: 2 },
				React.createElement('img', { src: this.props.iconUrl }),
				React.createElement(
					'div',
					{ className: 'material-card-infor' },
					React.createElement(
						'h3',
						{ className: 'card-title-link', onClick: this._openIndex },
						this.props.title,
						' '
					),
					React.createElement(
						'h5',
						{ className: 'card-readed-link', onClick: this._openPage },
						this.props.str + ' ' + this.props.lastReaded.text
					)
				),
				React.createElement(
					'div',
					{ className: 'trash', onClick: this._removeElemet },
					React.createElement('span', { className: 'lid' }),
					React.createElement('span', { className: 'can' })
				)
			);
		},
		_removeElemet: function _removeElemet(e) {
			this.props.removeElemet(e, this.props.index);
		},
		_openPage: function _openPage() {
			chrome.tabs.create({ url: this.props.lastReaded.payload });
		},
		_openIndex: function _openIndex() {
			console.log('this.props.indexURL', this.props.indexURL);
	...
	var Cards = React.createClass({
		...
		_getCollectedChildren: function _getCollectedChildren() {
			var children = [];
			...
			for (var i = this.state.collectedItems.length - 1; i >= 0; --i) {
				...
				var CardItem = React.createElement(Card, { key: i,
					str: '上次看到',
					index: i,
					title: item.title,
		...
		_getHistoryChildren: function _getHistoryChildren() {
			var children = [];
		...
		_getUpdateChildren: function _getUpdateChildren() {
			var children = [];
			// console.log(this.props.historyItems);
		...
		_removeCollected: function _removeCollected(e, index) {
			var array = [];
		...
		_removeHistory: function _removeHistory(e, index) {
			var array = [];
		...
		_removeUpdate: function _removeUpdate(e, index) {
			var array = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function injectTapEventPlugin() {
	  ...
	  __webpack_require__(21).injection.injectEventPluginsByName({
	    "ResponderEventPlugin": __webpack_require__(22),
	    "TapEventPlugin": __webpack_require__(23)
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  AppBar: __webpack_require__(31),
	  AppCanvas: __webpack_require__(32),
	  ...
	  EnhancedButton: __webpack_require__(33),
	  // FlatButton: require('./js/flat-button'),
	  // FloatingActionButton: require('./js/floating-action-button'),
	  FontIcon: __webpack_require__(34),
	  IconButton: __webpack_require__(35),
	  // Input: require('./js/input'),
	  LeftNav: __webpack_require__(36),
	  Menu: __webpack_require__(37),
	  MenuItem: __webpack_require__(38),
	  Mixins: {
	    Classable: __webpack_require__(39),
	    ClickAwayable: __webpack_require__(40),
	    WindowListenable: __webpack_require__(41)
	  },
	  Paper: __webpack_require__(42),
	  // RadioButton: require('./js/radio-button'),
	  // RadioButtonGroup: require('./js/radio-button-group'),
	  // RaisedButton: require('./js/raised-button'),
	  Slider: __webpack_require__(43),
	  SvgIcon: __webpack_require__(44),
	  Icons: {
	    NavigationMenu: __webpack_require__(45),
	    NavigationChevronLeft: __webpack_require__(46),
	    NavigationChevronRight: __webpack_require__(47)
	  },
	  Tab: __webpack_require__(48),
	  Tabs: __webpack_require__(49),
	  ...
	  Utils: {
	    ...
	    KeyCode: __webpack_require__(54),
	    KeyLine: __webpack_require__(55)
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TouchEventUtils = __webpack_require__(61);
	...
	var dependencies = [topLevelTypes.topMouseDown, topLevelTypes.topMouseMove, topLevelTypes.topMouseUp];

	if (EventPluginUtils.useTouchEvents) {
	  dependencies.push(topLevelTypes.topTouchEnd, topLevelTypes.topTouchStart, topLevelTypes.topTouchMove);
	}
	...
	var TapEventPlugin = {
	  ...
	  extractEvents: function extractEvents(topLevelType, topLevelTarget, topLevelTargetID, nativeEvent) {
	    ...
	    if (isEndish(topLevelType) && distance < tapMoveThreshold) {
	      event = SyntheticUIEvent.getPooled(eventTypes.touchTap, topLevelTargetID, nativeEvent);
	    }
	    if (isStartish(topLevelType)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Classable = __webpack_require__(39);
	var IconButton = __webpack_require__(35);
	var NavigationMenu = __webpack_require__(45);
	...
	var AppBar = React.createClass({ displayName: 'AppBar',
	  ...
	  render: function render() {
	    ...
	    if (this.props.title) {
	      ...
	      title = Object.prototype.toString.call(this.props.title) === '[object String]' ? React.createElement('h1', { className: 'mui-app-bar-title' }, this.props.title) : this.props.title;
	    }

	    if (this.props.showMenuIconButton) {
	      if (this.props.iconElementLeft) {
	        menuElementLeft = React.createElement('div', { className: 'mui-app-bar-navigation-icon-button' }, this.props.iconElementLeft);
	      } else {
	        ...
	        menuElementLeft = React.createElement(IconButton, {
	          ...
	          onTouchTap: this._onMenuIconButtonTouchTap }, child);
	      }
	    }

	    menuElementRight = this.props.children ? this.props.children : this.props.iconElementRight ? this.props.iconElementRight : '';

	    return React.createElement(Paper, { rounded: false, className: classes, zDepth: this.props.zDepth }, menuElementLeft, title, menuElementRight);
	  },

	  _onMenuIconButtonTouchTap: function _onMenuIconButtonTouchTap(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FocusRipple = __webpack_require__(100);
	var TouchRipple = __webpack_require__(101);
	...
	var EnhancedButton = React.createClass({ displayName: 'EnhancedButton',
	  ...
	  render: function render() {
	    var $__0 = this.props,
	        centerRipple = $__0.centerRipple,
	        disabled = $__0.disabled,
	        disableFocusRipple = $__0.disableFocusRipple,
	        disableTouchRipple = $__0.disableTouchRipple,
	        linkButton = $__0.linkButton,
	        onBlur = $__0.onBlur,
	        onFocus = $__0.onFocus,
	        onTouchTap = $__0.onTouchTap,
	        other = (function (source, exclusion) {
	    ...
	    })($__0, { centerRipple: 1, disabled: 1, disableFocusRipple: 1, disableTouchRipple: 1, linkButton: 1, onBlur: 1, onFocus: 1, onTouchTap: 1 });
	    ...
	    if (disabled && linkButton) {
	      return React.createElement('span', React.__spread({}, other, { className: classes,
	        disabled: disabled }), this.props.children);
	    }

	    return linkButton ? React.createElement('a', React.__spread({}, other, buttonProps), buttonChildren) : React.createElement('button', React.__spread({}, other, buttonProps), buttonChildren);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var React = __webpack_require__(12);
	var Classable = __webpack_require__(39);
	var EnhancedButton = __webpack_require__(33);
	var FontIcon = __webpack_require__(34);
	...
	var IconButton = React.createClass({ displayName: 'IconButton',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(EnhancedButton, React.__spread({}, other, { ref: 'button',
	      centerRipple: true,
	      className: classes,
	      onBlur: this._handleBlur,
	      onFocus: this._handleFocus,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyLine = __webpack_require__(55);
	var Classable = __webpack_require__(39);
	var ClickAwayable = __webpack_require__(40);
	var Paper = __webpack_require__(42);
	var MenuItem = __webpack_require__(38);
	var LinkMenuItem = __webpack_require__(104);
	var SubheaderMenuItem = __webpack_require__(105);
	...
	var Menu = React.createClass({ displayName: 'Menu',
	  ...
	  _getChildren: function _getChildren() {
	    ...
	    for (var i = 0; i < this.props.menuItems.length; i++) {
	      ...
	      })($__0, { icon: 1, data: 1, attribute: 1, number: 1, toggle: 1, onClick: 1 });
	      ...
	      switch (menuItem.type) {
	        ...
	        default:
	          itemComponent = React.createElement(MenuItem, React.__spread({}, other, { selected: isSelected,
	            key: i,
	            index: i,
	            icon: menuItem.icon,
	            data: menuItem.data,
	            ...
	            onTouchTap: this._onItemTap }), menuItem.text);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Classable = __webpack_require__(39);
	var FontIcon = __webpack_require__(34);
	var Toggle = __webpack_require__(103);
	...
	var MenuItem = React.createClass({ displayName: 'MenuItem',
	  ...
	  render: function render() {
	    ...
	    if (this.props.toggle) {
	      ...
	      })($__0, { toggle: 1, onClick: 1, onToggle: 1, children: 1, label: 1 });
	    ...
	    return React.createElement('div', {
	      ...
	      className: classes,
	      onTouchTap: this._handleTouchTap,
	      onClick: this._handleOnClick }, icon, this.props.children, data, attribute, number, toggle, iconRight);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(12);
	var classNames = __webpack_require__(113);
	...
	var Paper = React.createClass({ displayName: 'Paper',
	  ...
	  render: function render() {
	    var $__0 = this.props,
	        className = $__0.className,
	        circle = $__0.circle,
	        innerClassName = $__0.innerClassName,
	        rounded = $__0.rounded,
	        zDepth = $__0.zDepth,
	        other = (function (source, exclusion) {
	      var rest = {};var hasOwn = Object.prototype.hasOwnProperty;if (source == null) {
	    ...
	    })($__0, { className: 1, circle: 1, innerClassName: 1, rounded: 1, zDepth: 1 }),
	        classes = this.getClasses('mui-paper ' + 'mui-z-depth-' + this.props.zDepth, {
	    ...
	    return React.createElement('div', React.__spread({}, other, { className: classes }), React.createElement('div', { ref: 'innerContainer', className: insideClasses, style: this.props.innerStyle || {} }, this.props.children));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slider = React.createClass({ displayName: 'Slider',
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { className: classes, style: this.props.style }, React.createElement('span', { className: 'mui-input-highlight' }), React.createElement('span', { className: 'mui-input-bar' }), React.createElement('span', { className: 'mui-input-description' }, this.props.description), React.createElement('span', { className: 'mui-input-error' }, this.props.error), React.createElement('div', { className: sliderClasses, onClick: this._onClick }, React.createElement('div', { ref: 'track', className: 'mui-slider-track' }, React.createElement(Draggable, { axis: 'x', bound: 'point',
	      cancel: this.props.disabled ? '*' : null,
	      start: { x: percent * 100 + '%' },
	      onStart: this._onDragStart,
	      onStop: this._onDragStop,
	      onDrag: this._onDragUpdate }, React.createElement('div', { className: 'mui-slider-handle', tabIndex: 0 })), React.createElement('div', { className: 'mui-slider-selection mui-slider-selection-low',
	      style: { width: percent * 100 + '%' } }, React.createElement('div', { className: 'mui-slider-selection-fill' })), React.createElement('div', { className: 'mui-slider-selection mui-slider-selection-high',
	      style: { width: (1 - percent) * 100 + '%' } }, React.createElement('div', { className: 'mui-slider-selection-fill' })))), React.createElement('input', { ref: 'input', type: 'hidden',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgIcon = React.createClass({ displayName: 'SvgIcon',
	  ...
	  render: function render() {
	    ...
	    return React.createElement('svg', React.__spread({}, this.props, { className: classes,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationMenu = React.createClass({ displayName: 'NavigationMenu',
	  ...
	  render: function render() {
	    return React.createElement(SvgIcon, React.__spread({}, this.props), React.createElement('path', { d: 'M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z' }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationChevronLeft = React.createClass({ displayName: 'NavigationChevronLeft',
	  ...
	  render: function render() {
	    return React.createElement(SvgIcon, React.__spread({}, this.props), React.createElement('path', { d: 'M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z' }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationChevronLeft = React.createClass({ displayName: 'NavigationChevronLeft',
	  ...
	  render: function render() {
	    return React.createElement(SvgIcon, React.__spread({}, this.props), React.createElement('path', { d: 'M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z' }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(12);
	var Classable = __webpack_require__(39);
	var TabTemplate = __webpack_require__(107);
	...
	var Tab = React.createClass({ displayName: 'Tab',
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { className: classes, style: styles, onTouchTap: this.handleTouchTap, routeName: this.props.route }, this.props.label);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tab = __webpack_require__(48);
	var TabTemplate = __webpack_require__(107);
	var InkBar = __webpack_require__(108);
	...
	var Tabs = React.createClass({ displayName: 'Tabs',
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { className: 'mui-tabs-container' }, React.createElement('div', { className: 'mui-tab-item-container' }, tabs), React.createElement(InkBar, { left: left, width: width }), React.createElement(TabTemplate, null, currentTemplate));
	  } });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tooltip = React.createClass({ displayName: 'Tooltip',
	  ...
	  render: function render() {
	    ...
	    })($__0, { className: 1, label: 1 });
	    var classes = this.getClasses('mui-tooltip', {
	      'mui-is-shown': this.props.show,
	      'mui-is-touch': this.props.touch
	    });

	    return React.createElement('div', React.__spread({}, other, { className: classes }), React.createElement('div', { ref: 'ripple', className: 'mui-tooltip-ripple' }), React.createElement('span', { className: 'mui-tooltip-label' }, this.props.label));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PooledClass = __webpack_require__(111);
	var ReactFragment = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMIframe = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FocusRipple = React.createClass({ displayName: 'FocusRipple',
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { className: classes }, React.createElement('div', { className: 'mui-focus-ripple-inner' }));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Classable = __webpack_require__(39);
	var Dom = __webpack_require__(52);
	var RippleCircle = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Overlay = React.createClass({ displayName: 'Overlay',
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', React.__spread({}, other, { className: classes }));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Classable = __webpack_require__(39);
	var Paper = __webpack_require__(42);
	var EnhancedSwitch = __webpack_require__(198);
	...
	var Toggle = React.createClass({ displayName: 'Toggle',
	  ...
	  render: function render() {
	    ...
	    var toggleElement = React.createElement('div', null, React.createElement('div', { className: 'mui-toggle-track' }), React.createElement(Paper, { className: 'mui-toggle-thumb', zDepth: 1 }));
	    ...
	    return React.createElement(EnhancedSwitch, React.__spread({}, other, enhancedSwitchProps));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkMenuItem = React.createClass({ displayName: 'LinkMenuItem',
	    ...
	    render: function render() {
	        ...
	        return React.createElement('a', React.__spread({ key: this.props.index, className: classes }, link, { target: this.props.target, onClick: onClickHandler }), this.props.text);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubheaderMenuItem = React.createClass({ displayName: "SubheaderMenuItem",
	    ...
	    render: function render() {
	        return React.createElement("div", { key: this.props.index, className: "mui-subheader" }, this.props.text);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabTemplate = React.createClass({ displayName: "TabTemplate",
	  ...
	  render: function render() {
	    ...
	    return React.createElement("div", { className: "mui-tab-template" }, this.props.children);
	  } });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InkBar = React.createClass({ displayName: "InkBar",
	  ...
	  render: function render() {
	    ...
	    return React.createElement("div", { className: "mui-ink-bar", style: styles }, " ");
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(57);
	var LocalEventTrapMixin = __webpack_require__(212);
	var ReactBrowserComponentMixin = __webpack_require__(160);
	var ReactClass = __webpack_require__(81);
	var ReactElement = __webpack_require__(84);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CallbackQueue = __webpack_require__(222);
	var PooledClass = __webpack_require__(111);
	var ReactBrowserEventEmitter = __webpack_require__(185);
	...
	module.exports = React.createClass({
	  ...
	  handleDragEnd: function handleDragEnd(e) {
	    ...
	    if (bodyElement) {
	      ...
	      bodyElement.className = className.replace(/(?:^|\s+)react-draggable-dragging\b/, ' ');
	    }
	  },
	  ...
	  handleDrag: function handleDrag(e) {
	    ...
	    if (!constrain && Array.isArray(grid)) {
	      var constrainOffset = function constrainOffset(offset, prev, snap) {
	        var delta = offset - prev;
	        if (Math.abs(delta) >= snap) {
	  ...
	  _toPixels: function _toPixels(value) {

	    // Support percentages
	    if (typeof value == 'string' && value.slice(-1) == '%') {
	      return parseInt(+value.replace('%', '') / 100 * this.getDOMNode().offsetParent.clientWidth, 10) || 0;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RippleCircle = React.createClass({ displayName: 'RippleCircle',
	  ...
	  render: function render() {
	    ...
	    })($__0, { innerClassName: 1, started: 1, ending: 1 });
	    var classes = this.getClasses('mui-ripple-circle', {
	      'mui-is-started': this.props.started,
	      'mui-is-ending': this.props.ending
	    });

	    return React.createElement('div', React.__spread({}, other, { className: classes }), React.createElement('div', { className: 'mui-ripple-circle-inner' }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyCode = __webpack_require__(54);
	var Classable = __webpack_require__(39);
	var UniqueId = __webpack_require__(246);
	var WindowListenable = __webpack_require__(41);
	var FocusRipple = __webpack_require__(100);
	var TouchRipple = __webpack_require__(101);
	var Paper = __webpack_require__(42);
	...
	var EnhancedSwitch = React.createClass({ displayName: 'EnhancedSwitch',
	  ...
	  render: function render() {
	    var $__0 = this.props,
	        ...
	        value = $__0.value,
	        label = $__0.label,
	        onSwitch = $__0.onSwitch,
	        defaultSwitched = $__0.defaultSwitched,
	        onBlur = $__0.onBlur,
	        onFocus = $__0.onFocus,
	        onMouseUp = $__0.onMouseUp,
	        onMouseDown = $__0.onMouseDown,
	        onMouseOut = $__0.onMouseOut,
	        onTouchStart = $__0.onTouchStart,
	        onTouchEnd = $__0.onTouchEnd,
	        disableTouchRipple = $__0.disableTouchRipple,
	        disableFocusRipple = $__0.disableFocusRipple,
	        iconClassName = $__0.iconClassName,
	        other = (function (source, exclusion) {
	      var rest = {};var hasOwn = Object.prototype.hasOwnProperty;if (source == null) {
	        throw new TypeError();
	      }for (var key in source) {
	    ...
	    })($__0, { type: 1, name: 1, value: 1, label: 1, onSwitch: 1, defaultSwitched: 1, onBlur: 1, onFocus: 1, onMouseUp: 1, onMouseDown: 1, onMouseOut: 1, onTouchStart: 1, onTouchEnd: 1, disableTouchRipple: 1, disableFocusRipple: 1, iconClassName: 1 });
	    ...
	    var labelElement = this.props.label ? React.createElement('label', { className: 'mui-switch-label', htmlFor: inputId }, this.props.label) : null;
	    ...
	    var inputElement = React.createElement('input', React.__spread({}, other, inputProps, { className: 'mui-enhanced-switch-input' }));
	    ...
	    var switchElement = this.props.iconClassName.indexOf('toggle') == -1 ? React.createElement('div', { className: iconClassName }, this.props.switchElement, ripples) : React.createElement('div', { className: iconClassName }, React.createElement('div', { className: 'mui-toggle-track' }), React.createElement(Paper, { className: 'mui-toggle-thumb', zDepth: 1 }, ' ', ripples, ' '));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentWithPureRenderMixin = __webpack_require__(239);
	...
	var cloneWithProps = __webpack_require__(243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentEnvironment = __webpack_require__(218);
	var ReactMultiChildUpdateTypes = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getEventModifierState = __webpack_require__(255);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(241));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(266));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(84);
	var ReactPropTransferer = __webpack_require__(267);
